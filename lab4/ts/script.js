...
(function (Material) {
    Material["Silk"] = "\u0428\u0435\u043B\u043A";
    Material["Polyester"] = "\u0421\u0438\u043D\u0442\u0435\u0442\u0438\u043A\u0430";
    Material["Coton"] = "\u0425\u043B\u043E\u043F\u043E\u043A";
})(Material || (Material = {}));
;
...
function CheckGuarantee(flag) {
    document.getElementById('rowts').innerHTML = "";
    if (flag) {
        for (var i = 0; i < this.productList.length; i++)
            if (productList[i] instanceof PowerTool && productList[i].params.guarantee.length > 0)
                productList[i].Init();
    }
    else {
        for (var i = 0; i < this.productList.length; i++)
...
var Bedclothes = (function (_super) {
    __extends(Bedclothes, _super);
    function Bedclothes(id, name, price, description, inStock, prms) {
        var _this = _super.call(this, id, name, price, description, inStock) || this;
        _this.id = id;
        _this.name = name;
        _this.price = price;
    ...
    Bedclothes.prototype.Init = function () {
        var obj = _super.prototype.Init.call(this);
...
var PowerTool = (function (_super) {
    __extends(PowerTool, _super);
    function PowerTool(id, name, price, description, inStock, prms) {
        var _this = _super.call(this, id, name, price, description, inStock) || this;
        _this.id = id;
        _this.name = name;
        _this.price = price;
    ...
    PowerTool.prototype.Init = function () {
        var obj = _super.prototype.Init.call(this);
        if (!!this.params.kit) {
            var p = document.createElement("p");
            p.setAttribute("class", "card-text text-info m-0");
...
var Basket = (function () {
    ...
    Basket.prototype.Add = function (val) {
        ...
        if (isNaN(num) || !((num ^ 0) === num) || num == 0 || productList[val].inStock < num) {
            ...
            var itemIndex_1 = this.list.length;
            ...
            this.list[itemIndex_1] = { id: val, quantity: num };
